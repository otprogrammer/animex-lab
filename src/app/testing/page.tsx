...
const MediaScreen = ({
  ...
  const [data, setData] = useState([
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/Dc3U12kH3WA?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/tR8YH0G67Rk?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/H-3fre7943U?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/keti2rbgI6c?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/r9M34VgTfzY?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/ofXigq9aIpo?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/PKHQuQF1S8k?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/h3n-chI028E?enablejsapi=1&wmode=opaque&autoplay=1",
    ...
    },
    {
      ...
      "trailer_url": "https://www.youtube.com/embed/l_98K4_6UQ0?enablejsapi=1&wmode=opaque&autoplay=1",
  ...
  useEffect(() => {
    ...
    if (parentCardElement) {
      setIsOverflow(parentCardElement.scrollWidth > parentCardElement.clientWidth);
    }
      ...
      <div  className="banner grid grid-cols-6" id={"bannerDiv" + moveCount?.toString()}>
        {data?.map((item) => {
          return (
            ...
            <div   onMouseEnter={() => setTitle(item.title)}
            onMouseLeave={() => setHover(t => !t)} key={item.mal_id}>
