  ...
  return (
    <div className="p-2">
            <div className="flex justify-between">
              ...
              className="txt-primary cursor-pointer"
            >
              Episode {lastEpisode}
            </span></span>
              <div className="flex gap-1  ">
                ...
                <div onClick={handlePrevEpisode} className='flex items-center max-h-[30px] rounded-md gap-1 py-0.5 md:py-1 px-2.5 bg-neutral-800/50 cursor-pointer hover:bg-[#e11d48] transition-all duration-300 ease-out'>
                ...
                <div   onClick={handleNextEpisode}
 className='flex items-center max-h-[30px] rounded-md gap-1 py-0.5 md:py-1 px-2.5 bg-neutral-800/50 cursor-pointer hover:bg-[#e11d48] transition-all duration-300 ease-out'>
                <span>Next</span>
            ...
            <div className="flex text-[13px] md:text-lg  gap-3 justify-end mt-2">
              <span className={cls}>
