...
<div className="text-white   right-1 top-2 absolute ">
      ...
      <div className=" w-full flex  justify-center  items-center gap-1">
          ...
          <UserData title={'Username'} content={data?.username} icon={<FaUser size={20} />}/>

          <UserData title={'Description'} content={data?.description} icon={              <BsInfoLg size={20} />
}/>
          <UserData title={'Social Media'} content={""} icon={<IoShareSocial size={20} />}/>
          <UserData title={'Website'} content={data?.website} icon={<CgWebsite size={20} />}/>
          </div>
        ...
        <UserTab  WatchList={data?.watchlist} Favorites={data?.favs} refresh={() => setRefresh(!refresh)}/>
          ...
          <Account refresh={() => setRefresh(!refresh)} session={user} profileData={data} web_site={data?.website} isEdit={isEdit} onClose={() => setIsEdit(false)} desc={data?.description}/>
